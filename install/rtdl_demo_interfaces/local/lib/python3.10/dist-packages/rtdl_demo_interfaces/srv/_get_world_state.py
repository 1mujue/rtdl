...
class Metaclass_GetWorldState_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtdl_demo_interfaces.msg import WorldState
...
class GetWorldState_Response(metaclass=Metaclass_GetWorldState_Response):
    ...
    _fields_and_field_types = {
        'success': 'boolean',
        'message': 'string',
        'state': 'rtdl_demo_interfaces/WorldState',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['rtdl_demo_interfaces', 'msg'], 'WorldState'),  # noqa: E501
    )
...
class Metaclass_GetWorldState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'rtdl_demo_interfaces.srv.GetWorldState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from rtdl_demo_interfaces.srv import _get_world_state
...
class GetWorldState(metaclass=Metaclass_GetWorldState):
    from rtdl_demo_interfaces.srv._get_world_state import GetWorldState_Request as Request
    from rtdl_demo_interfaces.srv._get_world_state import GetWorldState_Response as Response
