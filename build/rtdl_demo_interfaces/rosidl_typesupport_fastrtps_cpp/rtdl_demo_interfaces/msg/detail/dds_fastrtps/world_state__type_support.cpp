...
#include "rtdl_demo_interfaces/msg/detail/world_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rtdl_demo_interfaces::msg::ObjectState &,
...
{
  // Member: robot_room
  cdr << ros_message.robot_room;
  // Member: holding_object
  cdr << ros_message.holding_object;
  // Member: robot_x
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rtdl_demo_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_ObjectState(
  ...
  if (is_plain) {
    ...
    using DataType = rtdl_demo_interfaces::msg::WorldState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rtdl_demo_interfaces::msg::WorldState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtdl_demo_interfaces::msg::WorldState *>(
    untyped_ros_message);
...
{
  return &rtdl_demo_interfaces::msg::typesupport_fastrtps_cpp::_WorldState__handle;
}
