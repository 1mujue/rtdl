...
#include "rtdl_demo_interfaces/srv/detail/pick__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtdl_demo_interfaces::srv::Pick_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtdl_demo_interfaces::srv::Pick_Request & ros_message)
{
  // Member: object_name
  cdr >> ros_message.object_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtdl_demo_interfaces::srv::Pick_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rtdl_demo_interfaces::srv::Pick_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtdl_demo_interfaces::srv::Pick_Request *>(
    untyped_ros_message);
...
{
  return &rtdl_demo_interfaces::srv::typesupport_fastrtps_cpp::_Pick_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtdl_demo_interfaces, srv, Pick_Request)() {
  return &rtdl_demo_interfaces::srv::typesupport_fastrtps_cpp::_Pick_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rtdl_demo_interfaces
cdr_serialize(
  const rtdl_demo_interfaces::srv::Pick_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtdl_demo_interfaces::srv::Pick_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rtdl_demo_interfaces::srv::Pick_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rtdl_demo_interfaces::srv::Pick_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rtdl_demo_interfaces::srv::Pick_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rtdl_demo_interfaces::srv::typesupport_fastrtps_cpp::_Pick_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtdl_demo_interfaces, srv, Pick_Response)() {
  return &rtdl_demo_interfaces::srv::typesupport_fastrtps_cpp::_Pick_Response__handle;
}
...
{
  return &rtdl_demo_interfaces::srv::typesupport_fastrtps_cpp::_Pick__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtdl_demo_interfaces, srv, Pick)() {
  return &rtdl_demo_interfaces::srv::typesupport_fastrtps_cpp::_Pick__handle;
}
