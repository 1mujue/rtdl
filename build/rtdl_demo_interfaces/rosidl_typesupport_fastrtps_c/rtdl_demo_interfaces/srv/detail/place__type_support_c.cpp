...
#include "rtdl_demo_interfaces/srv/detail/place__rosidl_typesupport_fastrtps_c.h"
...
using _Place_Request__ros_msg_type = rtdl_demo_interfaces__srv__Place_Request;
...
size_t get_serialized_size_rtdl_demo_interfaces__srv__Place_Request(
  const void * untyped_ros_message,
...
static uint32_t _Place_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtdl_demo_interfaces__srv__Place_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtdl_demo_interfaces
size_t max_serialized_size_rtdl_demo_interfaces__srv__Place_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtdl_demo_interfaces__srv__Place_Request;
    is_plain =
      (
...
static size_t _Place_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtdl_demo_interfaces__srv__Place_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtdl_demo_interfaces, srv, Place_Request)() {
...
using _Place_Response__ros_msg_type = rtdl_demo_interfaces__srv__Place_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtdl_demo_interfaces
size_t get_serialized_size_rtdl_demo_interfaces__srv__Place_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Place_Response__ros_msg_type * ros_message = static_cast<const _Place_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rtdl_demo_interfaces__srv__Place_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtdl_demo_interfaces
size_t max_serialized_size_rtdl_demo_interfaces__srv__Place_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rtdl_demo_interfaces__srv__Place_Response;
    is_plain =
      (
...
static size_t _Place_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtdl_demo_interfaces__srv__Place_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtdl_demo_interfaces, srv, Place_Response)() {
...
// already included above
// #include "rtdl_demo_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "rtdl_demo_interfaces/srv/place.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtdl_demo_interfaces, srv, Place)() {
