...
class Metaclass_Pick(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtdl_demo_interfaces.srv import _pick
...
class Pick(metaclass=Metaclass_Pick):
    from rtdl_demo_interfaces.srv._pick import Pick_Request as Request
    from rtdl_demo_interfaces.srv._pick import Pick_Response as Response
