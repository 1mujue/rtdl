...
{
  new (message_memory) rtdl_demo_interfaces::msg::ObjectState(_init);
}

void ObjectState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtdl_demo_interfaces::msg::ObjectState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectState_message_member_array[4] = {
  {
    ...
    offsetof(rtdl_demo_interfaces::msg::ObjectState, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtdl_demo_interfaces::msg::ObjectState, room),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtdl_demo_interfaces::msg::ObjectState, support),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtdl_demo_interfaces::msg::ObjectState, held_by_robot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectState_message_members = {
  ...
  4,  // number of fields
  sizeof(rtdl_demo_interfaces::msg::ObjectState),
...
{
  return &::rtdl_demo_interfaces::msg::rosidl_typesupport_introspection_cpp::ObjectState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtdl_demo_interfaces, msg, ObjectState)() {
  return &::rtdl_demo_interfaces::msg::rosidl_typesupport_introspection_cpp::ObjectState_message_type_support_handle;
}
